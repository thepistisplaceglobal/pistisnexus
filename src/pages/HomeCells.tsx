...
import { Filter, Home, MapPin, Users, Plus, Trash2, X } from "lucide-react";
...
export function HomeCells() {
  ...
  const filteredCells = selectedBranch === "All" 
    ? cells 
    : cells.filter((c) => c.branchName === selectedBranch);
          ...
          <div className="flex gap-3.5">
            ...
            <div>
               ...
               <p className="text-lilac/70 text-xs leading-relaxed max-w-xl mt-1">
                 Welcome, <strong>{user?.name || "Coordinator"}</strong>! As the **Home Cell Coordinator** directly under the **{userBranch} Branch**, you have spiritual and administrative oversight over all Home Cell Units in this locality.
               </p>
            </div>
          </div>
