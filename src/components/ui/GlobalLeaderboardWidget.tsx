    ...
    <GlassCard className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-3">
        {leaderboardData.length === 0 ? (
          <div className="text-center py-8 px-4 text-xs text-lavender/40 border border-dashed border-white/5 bg-white/[0.01] rounded-lg">
            No branch reports submitted yet to compile leaderboard rankings.
          </div>
        ) : (
