...
const allItems = [
  ...
  { path: "/departments", label: "Departments", icon: Users, roles: ["GLOBAL_ADMIN", "BRANCH_ADMIN"] },
  { path: "/homecells", label: "Cell Units", icon: Home, roles: ["GLOBAL_ADMIN", "BRANCH_ADMIN", "CELL_LEADER"] },
  { path: "/interest", label: "Interest Groups", icon: Compass, roles: ["GLOBAL_ADMIN", "BRANCH_ADMIN", "INTEREST_GROUP_LEADER"] },
  ...
  return (
    <div className="hidden md:flex flex-col w-64 h-screen fixed left-0 top-0 border-r border-royal-purple/20 bg-[#0B0118]/80 backdrop-blur-2xl z-40">
      <div className="p-6 flex items-center gap-3 pt-8">
        <img src="/logo.png" alt="Logo" className="w-10 h-10 object-contain drop-shadow-[0_0_15px_rgba(120,81,169,0.5)]" />
        <div>
