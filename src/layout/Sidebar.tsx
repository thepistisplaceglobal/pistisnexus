...
export function Sidebar() {
  ...
  const allItems = [
    ...
    { name: "Finance", id: "Finance", icon: Wallet, path: "/finance", roles: ["DEPT_LEADER", "CELL_LEADER", "INTEREST_GROUP_LEADER", "FOUNDATION_SCHOOL", "HOME_CELL_COORD"] },
    { name: "Departments", id: "Departments", icon: Users, path: "/departments", roles: ["BRANCH_ADMIN"] },
    { name: "Home Cells", id: "HomeCells", icon: Home, path: "/homecells", roles: ["BRANCH_ADMIN", "CELL_LEADER", "HOME_CELL_COORD", "DEPT_LEADER"] },
    { name: "Interest Groups", id: "InterestGroups", icon: Compass, path: "/interest", roles: ["BRANCH_ADMIN", "INTEREST_GROUP_LEADER"] },
    { name: "Foundation School", id: "FoundationSchool", icon: GraduationCap, path: "/foundationschool", roles: ["BRANCH_ADMIN", "FOUNDATION_SCHOOL"] },
